...
// using types = std::tuple<tensorwrapper::types::ifloat,
// tensorwrapper::types::idouble>; using namespace test_eigen_solver; using
...
//         spec.spacing           =
//         test_eigen_solver::EigenvalueSpacing::Linear; spec.seed = 11; auto
//         system            = generate_eigen_system<TestType>(spec); auto
//         [values, vectors] = mod.run_as<pt>(system.matrix);
//         require_eigenvalues_approx(values, system.eigenvalues, rtol);
//         require_eigenpair_residual(system.matrix, values, vectors, rtol);
//     }
...
//         spec.spacing          =
//         test_eigen_solver::EigenvalueSpacing::Clustered; spec.n_clusters = 3;
